...
?>
    ...
    <head>
        ...
        <title>Amc|Update Deducted Amount</title>
        <!-- Bootstrap Core CSS -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">                                 
						                  <strong>Update Deducted Amount Page</strong>
                                          <span class="pull-right">                                 
                                            </span>
											</div>
                                <div class="panel-body">
                                    <div class="table responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-UpdateDeductedPage">
                                            <thead>
                                                <tr>	
				
												<form name='changeForm' method='post'  action='UpdateDeducted.php'  role="form">
                                                <div class="panel-body">
                                                <div class="row">
                                                <div class="col-lg-12">
                                                    <label for="name"><br>New Deducted Amount</label>
                                                </div>
                                                <div class="form-group col-lg-3">
                                                    <label class="sr-only" for="name">New Deducted Amount</label>
                                                    <input type="text" class="form-control" placeholder="New Deducted Amount" id="newDeducted" name="newDeducted">
                                                </div>  
                                                <div class="col-lg-12">
                                                
                                                </div>
                                                    <div class="col-md-2">
                                                <button type='submit' name='updateDeducted_button' class="btn btn-primary btn-lg pull-right" style="margin-top: 20px">Submit</button>
                                            </div>
												</div>
												</div>                                             
                                                </tr>
